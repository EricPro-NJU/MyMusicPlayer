...
#include "../../MyMediaPlayer/searchdialog.h"
...
QT_MOC_LITERAL(1, 13, 10), // "search_end"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 13), // "SearchDialog*"
QT_MOC_LITERAL(4, 39, 23), // "on_searchButton_clicked"
QT_MOC_LITERAL(5, 63, 16), // "on_close_clicked"
QT_MOC_LITERAL(6, 80, 27), // "on_searchView_doubleClicked"
QT_MOC_LITERAL(7, 108, 5) // "index"

    },
    "SearchDialog\0search_end\0\0SearchDialog*\0"
    "on_searchButton_clicked\0on_close_clicked\0"
    "on_searchView_doubleClicked\0index"
};
...
void SearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->search_end((*reinterpret_cast< SearchDialog*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->on_searchButton_clicked(); break;
        case 2: _t->on_close_clicked(); break;
        case 3: _t->on_searchView_doubleClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< SearchDialog* >(); break;
            }
            break;
        }
        ...
        {
            typedef void (SearchDialog::*_t)(SearchDialog * , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchDialog::search_end)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SearchDialog::search_end(SearchDialog * _t1, int _t2)
{
